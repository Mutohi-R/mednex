  ...
  <article class="add-hospital | content-grid">
    <div class="mx-auto | grid gap-3">
      <div class="form__header | grid gap-3">
        <h1 class="ff-accent fs-700 fw-semibold text-clr-neutral-800">
          Hospital Entry Form
        </h1>
        <p class="fs-300">
          Please fill in the form below with the necessary information
        </p>
      </div>
      <form @submit.prevent="" ref="form" class="hospital__form | grid gap-3">
        <div class="general | flow">
          ...
          <div class="group">
            ...
            <div class="form__group">
              ...
              <select
                v-model="hospitalInfo.location"
                name="location"
                id="location"
              >
                <option disabled value="">Select hospital state</option>
                <option v-for="state in locations" :value="state">
                  {{ state }}
                </option>
              </select>
            </div>
          ...
          <div class="group">
            <div class="form__group">
              ...
              <input
                v-model="hospitalInfo.telephone"
                type="tel"
                name="phone"
                id="phone"
              />
        ...
        <div class="services | flow">
          <div>
            ...
            <p class="fs-300 text-clr-info-400">
              Only a maximum of 4 departments, click on a department to remove
              it
            </p>
          </div>
          <div class="form__group">
            ...
            <ul role="list" class="array__list">
              <li
                ...
                v-for="(item, index) in hospitalInfo.departments"
                :key="index"
              >
                {{ item }}
              </li>
          ...
          <div class="form__group">
            <div class="flex items-center gap-space-xs">
              ...
              <input
                v-model="hospitalInfo.emergencyCare"
                type="checkbox"
                name="emergency"
                id="emergency"
              />
            ...
            <div class="flex items-center gap-space-xs">
              ...
              <input
                class="w-full"
                :disabled="!hospitalInfo.emergencyCare"
                v-model="hospitalInfo.emergencyCareDetails"
                type="text"
          ...
          <div class="form__group">
            <div class="flex items-center gap-space-xs">
              ...
              <input
                v-model="hospitalInfo.accommodation"
                type="checkbox"
                name="accommodation"
                id="accommodation"
              />
            ...
            <div class="flex items-center gap-space-xs">
              ...
              <input
                class="w-full"
                :disabled="!hospitalInfo.accommodation"
                v-model="hospitalInfo.accommodationDetails"
                type="text"
          ...
          <div class="form__group">
            <div class="flex items-center gap-space-3xs">
              ...
              <VueDatePicker
                ...
                v-model="hospitalInfo.operatingFrom"
                :time-picker="true"
              ></VueDatePicker>
            </div>
            <div class="flex items-center gap-space-3xs">
              ...
              <VueDatePicker
                placeholder="Select time"
                v-model="hospitalInfo.operatingTo"
                :time-picker="true"
              ></VueDatePicker>
            </div>
          </div>
        ...
        <div class="payment | flow">
          ...
          <div class="form__group">
            <div class="flex items-center gap-space-xs">
              ...
              <input
                v-model="hospitalInfo.insurance"
                type="checkbox"
                name="insurance"
                id="insurance"
              />
            ...
            <div>
              <div class="add__array">
                ...
                <input
                  ...
                  :disabled="!hospitalInfo.insurance"
                  v-model="provider"
                  type="text"
                  name="providers"
                  id="providers"
              ...
              <ul role="list" class="array__list">
                <li
                  ...
                  v-for="(item, index) in hospitalInfo.insuranceProviders"
                  :key="index"
                >
                  {{ item }}
                </li>
          ...
          <div class="form__group">
            ...
            <ul role="list" class="array__list">
              <li
                ...
                v-for="(item, index) in hospitalInfo.paymentMethods"
                :key="index"
              >
                {{ item }}
              </li>
        ...
        <div class="facilities | flow">
          ...
          <div class="form__group">
            <div class="flex items-center gap-space-xs">
              ...
              <input
                v-model="hospitalInfo.facilities"
                type="checkbox"
                name="facilities"
                id="facilities"
              />
            ...
            <div>
              <div class="add__array">
                ...
                <input
                  ...
                  :disabled="!hospitalInfo.facilities"
                  v-model="facility"
                  type="text"
              ...
              <ul role="list" class="array__list">
                <li
                  ...
                  v-for="(item, index) in hospitalInfo.facilitiesDetails"
                  :key="index"
                >
                  {{ item }}
                </li>
        ...
        <div class="appointment | flow">
          ...
          <div class="form__group">
            ...
            <input
              v-model="hospitalInfo.appointment"
              type="text"
              name="appointment"
              id="appointment"
            />
        ...
        <div class="accessibility | flow">
          ...
          <div class="form__group">
            <div class="flex items-center gap-space-xs">
              ...
              <input
                v-model="hospitalInfo.accessibility"
                type="checkbox"
                name="accessibility"
                id="accessibility"
              />
            ...
            <div>
              <div class="add__array">
                <label for="accessibilityDetails">Details:</label>
                <input
                  @keyup.enter="addAccess"
                  :disabled="!hospitalInfo.accessibility"
                  v-model="access"
                  type="text"
              ...
              <ul role="list" class="array__list">
                <li
                  ...
                  v-for="(item, index) in hospitalInfo.accessibilityFeatures"
                  :key="index"
                >
                  {{ item }}
                </li>
          ...
          <div class="form__group">
            ...
            <input
              v-model="hospitalInfo.languageServices"
              type="text"
              name="language"
              id="language"
            />
        ...
        <div class="visit | flow">
          ...
          <div class="form__group group-1">
            <div class="flex items-center gap-space-3xs">
              ...
              <VueDatePicker
                placeholder="Select time"
                v-model="hospitalInfo.visitFrom"
                :time-picker="true"
              ></VueDatePicker>
            </div>
            <div class="flex items-center gap-space-3xs">
          ...
          <div class="form__group">
            ...
            <input
              v-model="hospitalInfo.visitGuide"
              type="text"
              name="guidelines"
              id="guidelines"
            />
        ...
        <button
          @click="submitHospitalEntry($event)"
          class="button"
          data-type="secondary"
        >
          Submit Form
...
.add-hospital {
  ...
  .form__header {
    ...
    border-block-start: 0.5rem solid var(--clr-primary-600);
